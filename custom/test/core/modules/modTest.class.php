...
class modTest extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->tabs = array();
		// Example:
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@test:$user->hasRight('test', 'read'):/test/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@test:$user->hasRight('othermodule', 'read'):/test/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		*/
		...
		$this->import_icon[$r]='myobject@test';
		...
		$this->import_convertvalue_array[$r] = array(
			't.ref' => array(
				...
				'path'=>"/core/modules/commande/".(!getDolGlobalString('TEST_MYOBJECT_ADDON') ? 'mod_myobject_standard' : getDolGlobalString('TEST_MYOBJECT_ADDON')).'.php'
	...
	public function init($options = '')
	{
		...
		//$result1=$extrafields->addExtraField('test_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'test@test', 'isModEnabled("test")');
		//$result2=$extrafields->addExtraField('test_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', 0, 0, '', '', 'test@test', 'isModEnabled("test")');
		//$result3=$extrafields->addExtraField('test_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'test@test', 'isModEnabled("test")');
		//$result4=$extrafields->addExtraField('test_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', 0, 0, '', '', 'test@test', 'isModEnabled("test")');
		//$result5=$extrafields->addExtraField('test_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'test@test', 'isModEnabled("test")');
